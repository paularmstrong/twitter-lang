...
describe('urls_with_indices', () => {
  ...
  it("Extract a URL from a Japanese tweet", () => {
  ...
  it("Extract URLs without protocol surrounded by CJK characters", () => {
  ...
  it("Extract t.co URLs skipping trailing characters and adjusting indices correctly", () => {
  ...
  it("Extract correct indices for duplicate instances of the same URL", () => {
  ...
  it("Extract URLs with IDN(not encoded)", () => {
